...
<head>
  ...
  <script defer src="/Scripts/Libs/jquery.ui.touch-punch.min.js"></script>
  ...
  <script>
        require(['/Scripts/require.config.js'], function () {
            require(['/Scripts/Pages/ApplicationForm/startup.js']);
        });
  </script>
</head>
<body>
        ...
        <div class="calculator">
          <div class="row">
            ...
            <div class="right range_slider">
              ...
              <div id="loanAmountSlider" class="slider need ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content ui-draggable ui-draggable-handle">
                <div class="ui-slider-range ui-corner-all ui-widget-header ui-slider-range-min"></div><span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default" style="left: 37.5%;"></span>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="right range_slider">
              ...
              <div id="loanTermSlider" class="slider month ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content ui-draggable ui-draggable-handle">
                <div class="ui-slider-range ui-corner-all ui-widget-header ui-slider-range-min"></div><span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default" style="left: 70.5882%;"></span>
              </div>
            </div>
          </div>
        </div>
        <form action="#" class="reg_form">
          <div class="section">
            <div class="row">
              ...
              <div class="right">
                We use these details to confirm that it is you making the application
              </div>
            </div>
            <div class="row">
              <div class="left">
              ...
              <div class="right count2">
                <div class="item">
                  <input type="text" data-bind="value: dataModel.firstName" placeholder="First name">
                </div>
                <div class="item">
                  <input type="text" data-bind="value: dataModel.lastName" placeholder="Last name">
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="right count3">
                <div class="item">
                  <select data-bind="options: dayOptions, value: day, optionsCaption: 'Day'">
                  </select>
                </div>
                <div class="item">
                  <select data-bind="options: monthOptions, optionsValue: 'value', optionsText: 'title', value: month, optionsCaption: 'Month'">
                  </select>
                </div>
                <div class="item">
                  <select data-bind="options: yearOptions, value: year, optionsCaption: 'Year'">
                  </select>
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="right">
                <div class="item">
                  <input type="tel" data-bind="value: dataModel.primaryPhone" placeholder="Home phone">
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="right">
                <div class="item">
                  <input type="email" data-bind="value: dataModel.email" placeholder="Enter your e-mail">
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="right">
                <div class="item">
                  <select data-bind="options: isMilitaryOptions, optionsValue: 'value', optionsText: 'title', value: dataModel.isMilitary, optionsCaption: 'Select'">
                  </select>
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="right">
                <div class="item">
                  <select data-bind="options: isHomeOwnerOptions, optionsValue: 'value', optionsText: 'title', value: dataModel.isHomeOwner, optionsCaption: 'Select'">
                  </select>
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="right">
                <div class="item">
                  <select data-bind="options: isCarOwnerOptions, optionsValue: 'value', optionsText: 'title', value: dataModel.isCarOwner, optionsCaption: 'Select'">
                  </select>
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="right count2 first-big">
                <div class="item">
                  <input type="text" data-bind="value: dataModel.driversLicenceNumber" placeholder="Drivers license number">
                </div>
                <div class="item">
                  <select data-bind="options: driversLicenceOptions, optionsValue: 'value', optionsText: 'title', value: dataModel.driversLicenceState, optionsCaption: 'State'">
                  </select>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="left">
                Intersted in Auto Loan?
              </div>
              <div class="right">
                <div class="item">
                  <select data-bind="options: interestedInAutoLoanOptions, optionsValue: 'value', optionsText: 'title', value: dataModel.isAutoLoanInterested, optionsCaption: 'Select'">
                  </select>
                </div>
              </div>
            </div>
          ...
          <div class="section">
            ...
            <div class="row">
              <div class="left">
                Street / House / Postcode
              </div>
              <div class="right count3 second-big">
                <div class="item">
                  <input type="text" data-bind="value: dataModel.street" placeholder="Your street">
                </div>
                <div class="item">
                  <input type="text" data-bind="value: dataModel.house" placeholder="Number or name of house">
                </div>
                <div class="item">
                  <input type="tel" data-bind="value: dataModel.postcode" placeholder="Postcode">
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="right count2">
                <div class="item">
                  <input type="text" data-bind="value: dataModel.state, disable: true" placeholder="Your city">
                </div>
                <div class="item">
                  <input type="text" data-bind="value: dataModel.city, disable: true" placeholder="Your city">
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="right">
                <div class="item">
                  <select data-bind="options: monthsAtAdressOptions, optionsValue: 'value', optionsText: 'title', value: dataModel.monthAtAdress, optionsCaption: 'Select'">
                  </select>
                </div>
              </div>
            </div>
          ...
          <div class="section">
            <div class="row aligt_top">
              <div class="left">
                Your income <span>Note: we do not inform you employer, or anyone else of your loan request.</span>
              </div>
              <div class="right">
                We use these details to decide how easily and when you can pay us back
              </div>
            </div>
            <div class="row">
              <div class="left">
              ...
              <div class="right count2">
                <div class="item">
                  <input type="text" data-bind="value: dataModel.employer" placeholder="Employer name">
                </div>
                <div class="item">
                  <select data-bind="options: monthEmployedOptions, optionsValue: 'value', optionsText: 'title', value: dataModel.monthsEmployed, optionsCaption: 'Month employed'">
                  </select>
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="right count2">
                <div class="item">
                  <select data-bind="options: getGrossIncome(), optionsValue: 'value', optionsText: 'title', value: dataModel.income, optionsCaption: 'Gross monthly income'">
                  </select>
                </div>
                <div class="item">
                  <select data-bind="options: incomeTypeOptions, optionsValue: 'value', optionsText: 'title', value: dataModel.incomeType, optionsCaption: 'Income type'">
                  </select>
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="right">
                <div class="item">
                  <input type="tel" data-bind="value: dataModel.employerPhone" placeholder="Put employer phone number">
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="right">
                <div class="item">
                  <div class="item">
                    <input type="tel" data-bind="value: dataModel.extension" placeholder="Ext.">
                  </div>
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="right">
                <div class="item">
                  <select data-bind="options: isPaycheckReceivedOptions, optionsValue: 'value', optionsText: 'title', value: dataModel.isPaycheckReceived, optionsCaption: 'Select'">
                  </select>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="left">
                How often are Your paid?
              </div>
              <div class="right">
                <div class="item">
                  <select data-bind="options: paymentFrequencyOptions, optionsValue: 'value', optionsText: 'title', value: dataModel.paymentFrequency, optionsCaption: 'Select'">
                  </select>
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="right">
                <div class="item">
                  <select data-bind="options: getDates(), optionsValue: 'value', optionsText: 'title', value: dataModel.nextPaydate, optionsCaption: 'Select'">
                  </select>
                </div>
              </div>
            </div>
          ...
          <div class="section">
            <div class="row">
              ...
              <div class="right">
                Please enter the details of the account you want the funds deposited into.
              </div>
            </div>
            <div class="row">
              <div class="left">
              ...
              <div class="right">
                <div class="item">
                  <input type="text" data-bind="value: dataModel.accountNumber" placeholder="Your account number">
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="right">
                <div class="item">
                  <input type="text" data-bind="value: dataModel.abaNumber" placeholder="Your routing number">
                  <div class="question">
                    ?
                  </div>
                </div>
            ...
            <div class="row">
              ...
              <div class="right">
                <div class="item">
                  <select data-bind="options: accountTypeOptions, optionsValue: 'value', optionsText: 'title', value: dataModel.typeOfBankAccount, optionsCaption: 'Select'">
                  </select>
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="right">
                <div class="item">
                  <select data-bind="options: monthAtBankOptions, optionsValue: 'value', optionsText: 'title', value: dataModel.monthsAtBank, optionsCaption: 'Select'">
                  </select>
                </div>
              </div>
            </div>
            <div class="row">
              ...
              <div class="right">
                <div class="item">
                  <input type="text" data-bind="value: dataModel.bankName" placeholder="Enter bank name">
                  <div class="question">
                    ?
                  </div>
                </div>
            ...
            <div class="row">
              ...
              <div class="right">
                <div class="item">
                  <input type="text" data-bind="value: dataModel.ssn" placeholder="XXX - XX - XXXX">
                  <div class="question">
                    ?
                  </div>
                </div>
          ...
          <div class="section confirm">
            <label><input type="checkbox" data-bind="checked: dataModel.isConfirmed" name="confirm"> <span class="check"></span></label>
            <p>Nouveau Finance and our carefully selected partners would like to keep you informed of products and services which may be of interest to you. Contact will be made via telephone, email, SMS, automated messages or fax using the information you have provided. If you would like to receive details of up-to-date products and services, please tick the box. You can of course choose to opt-out of receiving such communications at any time</p>
          </div>
          <div class="section submit">
            <div class="btn_wrap">
              <button class="move_gradient button_radial_gradient" data-bind="click: getLoanClick" bg-color="#da8522" radial-gradient-color="#e5b92d" size="50%"><span>get loan from</span> <span>credit companies</span></button>
            </div><a href="#">or get loan from your friends</a>
          </div>
          <div class="steps_registration">
            <div>
              1
            </div>
            <div>
      ...
      <div class="container">
        ...
        <div class="column">
          <form action="#">
            ...
            <div class="wrap">
              <input type="text" placeholder="Enter your email"> <input type="button" value="sign up" bg-color="#07c4ed" radial-gradient-color="#03ddce" class="move_gradient" size="70%">
            </div>
          </form>
          <div class="markets">
